...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{config('app.name')}} - {{auth()->user()->firstname.' ' .auth()->user()->lastname ?? '' }} | Clients</title>
        ...
        <link rel="stylesheet" href="{{ asset('css/adminClient.css') }}">
    ...
    <body>
        <div id="app">
            <temp-password-change-component />
        </div>
