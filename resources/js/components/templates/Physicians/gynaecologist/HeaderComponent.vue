                ...
                <div class="container">
                    ...
                    >
                        <div class="flex justify-between align-center">
                            <h5
                                class="headerTitle hide-on-small-only"
                                v-if="!editing"
                            >
                            ...
                            >
                                <input
                                    type="text"
                                    class="custom-edit-field browser-default"
                                    v-model="userReplaced"
                                />
                                <div class="ml-3">
                                    <span v-if="editHeaderTitle">
                                        <i
                                            class="fa-solid fa-gear primary fs-1 fa-spin"
                                        ></i>
                                    </span>
                                    <span v-else>
                                        <a href="#!"
                                            ><i
                                                class="fa-regular fa-circle-xmark primary fs-1"
                                                @click="edit(0)"
                                            ></i
                                        ></a>
                                        <a
                                            href="#!"
                                            class="pl-3"
                                            @click="confirmHeaderEdit"
                                            ><i
                                                class="fa-solid fa-check primary fs-1"
                                            ></i
                                        ></a>
                                    </span>
                                </div>
    ...
    <div id="showSettingsModal" class="modal">
        <div class="modal-content" v-if="isLoggedIn">
            <div v-if="modalView == 0" class="settingModalViewInitial">
                <div class="row">
                    <div
                        class="flex mb-2"
                        :class="{
                            'justify-end': !clickedSub,
                            'justify-between': clickedSub,
                        }"
                    >
                        <a
                            href="#!"
                            v-if="clickedSub"
                            @click="clickedSub = false"
                            class="flex align-center gap-3 black-text fw-500 fs-125 dec-none"
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="30"
                    ...
                    <div class="col l12 m12 s12">
                        <h3 class="mt-0 fw-500 fs-175">
                            {{
                                !userSubscribed && !clickedSub
                                    ? "Settings"
                                    : "Subscribe"
                            }}
                        </h3>
                        <p class="marginTop-1 supportTxt">
                            {{
                                !userSubscribed && !clickedSub
                                    ? "Update your website by selecting any of the links below"
                                    : "Update your website by selecting any of the Packages below"
                            }}
                        </p>
                    </div>
                </div>
            ...
            <div class="flex justify-center flex-col align-center">
                ...
                <p
                    v-if="!userSubscribed && !clickedSub"
                    class="fs-9 supportTxt"
                >
                    <b> Subscribe now to access/make changes to your site</b>
                </p>
            </div>
        </div>
    </div>
    ...
    export default {
        ...
        methods: {
            confirmHeaderEdit() {
                ...
                axios
                    .post("/api/saveOrUpdateHeaderTitle", {
                        headerTitle: this.userReplaced,
                    })
                    .then((res) => {
