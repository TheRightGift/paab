        ...
        <span v-if="type === 'main'">
            ...
            <nav v-bind:class="scrollPosition >= 5 ? 'altNav' : 'navbar', 'hide-on-med-and-down'">
                <div class="nav-wrapper navbarWrap">
                    <a href="/" v-bind:class="scrollPosition >= 5 ? 'altBrandLogo' : 'brandLogo'">PaaB</a>
                    <ul id="nav-mobile" class="section table-of-contents right hide-on-med-and-down">
                        ...
                        <li><a href="/template" id="navLinks">Templates</a></li>
            ...
            <nav class="hide-on-large-only white" id="sideNav">
                <a href="#" data-target="slide-out" class="sidenav-trigger"><i class="material-icons black-text sideNavIcon" id="sideNavIcon">menu</i></a>
            ...
            <nav v-bind:class="scrollPosition >= 5 ? 'altNav' : 'navbar', 'hide-on-med-and-down'">
                <div class="nav-wrapper navbarWrap">
                    ...
                    <ul id="nav-mobile" class="section right table-of-contents hide-on-med-and-down">
                        ...
                        <li class="marginLeft-25"><a href="/auth/login" class="right tempLoginLink" id="loginLink">Log in</a></li>
                    </ul>                
                </div>
            </nav>
