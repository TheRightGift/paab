        ...
        <div class="clientCreatePortModalDiv">
            ...
            <div v-if="user.role === 'Admin' || user.role === 'SuperAdmin'">
                <div class="row createWebRow" v-if="webCreateViewState === 0">
                    <div class="col l6 createWebSectionTitle center-align">
                        ...
                        <p>
                            <small
                                >A working email address to be able to identify
                                your client <b>hello@example.com</b></small
                            >
                        </p>
                    </div>
            ...
            <div class="row createWebRow" v-if="webCreateViewState === 1">
                <div class="col l6 createWebSectionTitle center-align">
                    ...
                    <p>
                        <small
                            >If your names and title are Dr. Mark Cable and you
                            want your domain name to be
                            <b>www.drmarkcable.com</b>, please enter
                            <b>drmarcable</b></small
                        >
                    </p>
                </div>
                <div class="col l6 createWebsiteDomainName">
            ...
            <div class="row createWebRow" v-if="webCreateViewState === 2">
                <div class="col l6 createWebsiteDomainName">
                ...
                <div class="col l6 createWebSectionTitle center-align">
                    ...
                    <p class="center-align">
                        <small
                            >Providing a good description helps us setup SEO for
                            your site.</small
                        >
                    </p>
                </div>
            ...
            <div
                ...
                v-if="webCreateViewState === 3"
            >
                <TemplatePreviewComponent
                    :selectedTemplate="web.template_id"
            ...
            <div class="row websiteCreateBtnRow gutterTop-10">
                <button
                    ...
                    @click="prevWebsiteCreateView()"
                    :disabled="disablePrev"
                >
                    <i class="material-icons left">navigate_before</i>Prev
                </button>
                <button
                    type="button"
                ...
                >
                    <span v-if="!loading"
                        ><i class="material-icons right">send</i>CREATE</span
                    >
    ...
    export default {
        ...
        mounted() {
            this.user.role === "Admin" || this.user.role === "SuperAdmin"
                ? (this.webCreateViewState = 0)
                : (this.webCreateViewState = 1);
        },
        computed: {
            disableCr8() {
                if (
            ...
            disablePrev() {
                if (this.user.role === "Admin" || this.user.role === "SuperAdmin") {
                    ...
                    if (this.webCreateViewState == 1) {
                        return true;
                    }
                }
            },
            disableNxt() {
                if (this.webCreateViewState == 3) {
                    return true;
                }
            },
        },
